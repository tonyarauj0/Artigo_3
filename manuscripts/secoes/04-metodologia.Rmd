...
Voltando ao método de validação cruzada, buscou-se um conjunto de combinações entre $\alpha$ e $\beta$ que alcançasse a melhor média entre, as *k* subamostras, da métrica de avaliação do modelo. Como o intuito desta pesquisa não é previsão, definiu-se como métrica o erro quadrático médio (EQM). 
